...
class WorkspaceContext {
    ...
    workspaceRoots;
    indexers = new Map();
    findNamespaceRootsUsingTypeCache;
    initSfdxProjectConfigCache;
    AURA_EXTENSIONS = ['.cmp', '.app', '.design', '.evt', '.intf', '.auradoc', '.tokens'];
    /**
    ...
    processTemplate(templateString, variableMap) {
        ...
        return ejs_1.default.render(ejsTemplate, variableMap);
    }
    /**
