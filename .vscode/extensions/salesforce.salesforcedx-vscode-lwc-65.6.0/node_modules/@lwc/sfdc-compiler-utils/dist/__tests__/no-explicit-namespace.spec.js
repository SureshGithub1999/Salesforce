...
describe('disallow references with an explicit namespace', () => {
    ...
    describe('explicit namespace in site local(Code Behind) component', () => {
        test('should return "true" when using site namespace in label import', () => {
            expect((0, namespace_utils_1.containsExplicitNamespace)('site.buttonLabel', 'label', 'site')).toBe(true);
        });
        test('should return "true" when using site namespace in source url reference', () => {
            const actual = (0, namespace_utils_1.containsExplicitNamespace)('site__resourceUrl', 'resourceUrl', 'site');
            expect(actual).toBe(true);
        });
        test('should return "false" when using site namespace in component reference', () => {
            expect((0, namespace_utils_1.containsExplicitNamespace)('site-button', 'component', 'site')).toBe(false);
        });
        test('should return "false" when using site namespace in component reference', () => {
            expect((0, namespace_utils_1.containsExplicitNamespace)('site/buttonUtil', 'module', 'site')).toBe(false);
        });
    });
});
