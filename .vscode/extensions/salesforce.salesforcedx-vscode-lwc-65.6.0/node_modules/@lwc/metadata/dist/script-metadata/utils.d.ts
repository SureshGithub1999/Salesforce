...
import { BundleType, NamespaceMapping, NpmModuleMapping } from '../shared/config';
...
export declare class ScriptState extends State {
    constructor({ fileName, namespaceMapping, npmModuleMapping, bundleType, source, fileType, }: {
        fileName: string;
        namespaceMapping: NamespaceMapping;
        npmModuleMapping: NpmModuleMapping;
