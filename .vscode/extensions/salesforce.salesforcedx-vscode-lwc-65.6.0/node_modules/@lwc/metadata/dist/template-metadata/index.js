...
function collectTemplateMetadataFromSource(fileName, source, config) {
    ...
    try {
        parseResult = templateCompiler.parse(source, {
            ...
            // @lwc/template-compiler has a bug where an undefined apiVersion is _not_ treated as latest
            // We can temporarily work around it by doing this spread based on whether it's truthy or not (i.e. a double
            // like 58 or 59).
            // This can be simplified once https://github.com/salesforce/lwc/pull/3696 is released
