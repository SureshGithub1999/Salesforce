import { ScriptFile } from '@lwc/metadata';
import { Metadata as InternalMetadata } from '@salesforce/lightning-lsp-common';
/**
 ...
 */
export declare function mapLwcMetadataToInternal(lwcMeta: ScriptFile): InternalMetadata;
